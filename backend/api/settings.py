...
import datetime  # 64 에서 시작되는 JWT_AUTH 의 토큰 유효기간을 설정하기 위한 datetime
...
SECRET_KEY = "django-insecure-ak7^5!v%+@*z3pc_u3a+j3n8)c@6(h4)m(va$avrs%)mooy4*n"
...
MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware",  # 첫줄에!!추가
